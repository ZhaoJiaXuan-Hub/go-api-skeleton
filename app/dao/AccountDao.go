...
func AccountDetailByUsername(username string) (systemAccount account_entity.Account, err error) {
...
func AccountDetailById(id uint) (account account_entity.Account, err error) {
...
// AccountCreate 新增用户
func AccountCreate(account account_entity.Account) (err error) {
